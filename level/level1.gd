...
func _ready():
	...
	wave_config = {
		...
		5: {"count": 1, "health_multiplier": 1.8, "speed_multiplier": 1.2, "path_type": PathType.PATH_1, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		10: {"count": 2, "health_multiplier": 6, "speed_multiplier": 1.5, "path_type": PathType.PATH_1, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}}
	}
