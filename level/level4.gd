...
func _ready():
	...
	wave_config = {
		...
		5: {"count": 1, "health_multiplier": 2.3, "speed_multiplier": 1.25, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		10: {"count": 1, "health_multiplier": 3.5, "speed_multiplier": 1.5, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
		...
		15: {"count": 1, "health_multiplier": 10.0, "speed_multiplier": 1.75, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		20: {"count": 1, "health_multiplier": 20.0, "speed_multiplier": 2.0, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
	}
