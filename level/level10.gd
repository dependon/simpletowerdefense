...
func _ready():
	...
	# 前期: 混合多种类型，战士和狼人比例逐渐增加
		...
		15: {"count": 1, "health_multiplier": 9.6, "speed_multiplier": 2.14, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		20: {"count": 1, "health_multiplier": 11.8, "speed_multiplier": 2.55, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
