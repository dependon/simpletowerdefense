...
# 包含敌人类型混合比例，引入巫师敌人
	wave_config = {
		...
		5:  {"count": 22, "health_multiplier": 3.8, "speed_multiplier": 1.4, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.NORMAL: 0.4, EnemyManager.EnemyType.THIEF: 0.4, EnemyManager.EnemyType.WIZARD: 0.2}},
		...
		10: {"count": 35, "health_multiplier": 5.2, "speed_multiplier": 1.65, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.THIEF: 0.4, EnemyManager.EnemyType.WIZARD: 0.6}}, # 巫师和盗贼混合
		...
		15: {"count": 48, "health_multiplier": 6.7, "speed_multiplier": 1.9, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.NORMAL: 0.1, EnemyManager.EnemyType.THIEF: 0.2, EnemyManager.EnemyType.WIZARD: 0.3, EnemyManager.EnemyType.WARRIOR: 0.4}},
		...
		20: {"count": 70, "health_multiplier": 9.0, "speed_multiplier": 2.3, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.NORMAL: 0.1, EnemyManager.EnemyType.THIEF: 0.2, EnemyManager.EnemyType.WIZARD: 0.3, EnemyManager.EnemyType.WARRIOR: 0.4}} # 最终混合波
	}
