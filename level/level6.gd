...
# 包含敌人类型混合比例，引入巫师敌人
	wave_config = {
		...
		10: {"count": 1, "health_multiplier": 10.0, "speed_multiplier": 1.65, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
		...
		15: {"count": 1, "health_multiplier": 20.0, "speed_multiplier": 1.9, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		20: {"count": 1, "health_multiplier": 50.0, "speed_multiplier": 2.3, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}}
	}
