...
func _ready():
	...
	# 前期: 混合多种类型，战士和狼人比例逐渐增加
		...
		15: {"count": 60, "health_multiplier": 9.7, "speed_multiplier": 2.2, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.WIZARD: 0.2, EnemyManager.EnemyType.WEREWOLF: 0.8}},
		...
		20: {"count": 70, "health_multiplier": 12.0, "speed_multiplier": 2.6, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.WIZARD: 0.3, EnemyManager.EnemyType.WARRIOR: 0.3, EnemyManager.EnemyType.WEREWOLF: 0.4}},
