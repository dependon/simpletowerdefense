...
func _ready():
	...
	# 前期: 混合多种类型，战士和狼人比例逐渐增加
		...
		10: {"count": 1, "health_multiplier": 40.0, "speed_multiplier": 1.95, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
		...
		15: {"count": 1, "health_multiplier": 60.0, "speed_multiplier": 2.2, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		20: {"count": 1, "health_multiplier": 80.0, "speed_multiplier": 2.6, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
