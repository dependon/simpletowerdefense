...
func _ready():
	...
	wave_config = {
		...
		5:  {"count": 25, "health_multiplier": 2.8, "speed_multiplier": 1.5, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.NORMAL: 0.3, EnemyManager.EnemyType.THIEF: 0.3, EnemyManager.EnemyType.WIZARD: 0.2, EnemyManager.EnemyType.WARRIOR: 0.2}},
		...
		10: {"count": 38, "health_multiplier": 6.2, "speed_multiplier": 1.75, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.THIEF: 0.2, EnemyManager.EnemyType.WIZARD: 0.3, EnemyManager.EnemyType.WARRIOR: 0.4, EnemyManager.EnemyType.WEREWOLF: 0.1}}, # 引入狼人
		...
		15: {"count": 50, "health_multiplier": 7.7, "speed_multiplier": 2.0, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.WIZARD: 0.3, EnemyManager.EnemyType.WARRIOR: 0.2, EnemyManager.EnemyType.WEREWOLF: 0.5}},
		...
		20: {"count": 75, "health_multiplier": 10.0, "speed_multiplier": 2.4, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.WEREWOLF: 1.0}}, # 全是狼人
