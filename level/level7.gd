...
func _ready():
	...
	wave_config = {
		...
		10: {"count": 1, "health_multiplier": 6.2, "speed_multiplier": 1.75, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
		...
		15: {"count": 1, "health_multiplier": 7.7, "speed_multiplier": 2.0, "path_type": PathType.PATH_2, "enemy_mix": {EnemyManager.EnemyType.ORC: 1.0}},
		...
		20: {"count": 1, "health_multiplier": 10.0, "speed_multiplier": 2.4, "path_type": PathType.BOTH_PATHS, "enemy_mix": {EnemyManager.EnemyType.CRAZYONE: 1.0}},
